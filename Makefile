...
start-my-l2: NGSDN_TOPO_PY := my-topo-l2.py
start-my-l2: _start
...
start-my-lb: NGSDN_TOPO_PY := my-topo-lb.py
start-my-lb: _start
...
unpause:
	@NGSDN_TOPO_PY=foo docker-compose unpause
...
netcfg: NGSDN_NETCFG_JSON := my-netcfg-lb.json
netcfg: _netcfg

netcfg-my-v4: NGSDN_NETCFG_JSON := my-netcfg-v4.json
netcfg-my-v4: _netcfg

netcfg-my-l2: NGSDN_NETCFG_JSON := my-netcfg-l2.json
netcfg-my-l2: _netcfg
...
netcfg-my-lb: NGSDN_NETCFG_JSON := my-netcfg-lb.json
netcfg-my-lb: _netcfg
